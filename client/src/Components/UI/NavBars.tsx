        ...
        <div>
            <div className="z-0	 p-2 md:px-24 flex justify-between border-b border-black">
                ...
                <div className=" flex items-center">
                    <div className="hidden md:block p-2 ml-2 md:mx-2 md:py-2 md:px-4 cursor-pointer"
                        onClick={() => {
                            navigate("/all")
                        }}>Read</div>
                    <div className="hidden md:block p-2 ml-2 md:mx-2 md:py-2 md:px-4 cursor-pointer"
                    ...
                    <div className="hidden md:block p-2 ml-2 md:mx-2 md:py-2 md:px-4 cursor-pointer"
                     ...
                     <div className="block md:hidden p-2 ml-2 md:mx-2 md:py-2 md:px-4 cursor-pointer"
